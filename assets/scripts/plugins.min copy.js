        ...
        i = {
            ...
            out: function (n, o) {
                var s = this,
                    ...
                    h = l ? l : c,
                    d = u ? u : p,
                    f = i.animationCheck.call(s, h, !0, !1),
            ...
            var o = t(window),
                s = function () {
                    ...
                    var t = o.scrollLeft(),
                        ...
                        h = i.width(),
                        d = o.width();
                    a + u + c >= e && e + p + c >= a && r + h + l >= t && t + d + l >= r ? i.appeared || i.trigger("appear", n.data) : i.appeared = !1
                },
                r = function () {
...
function () {
        ...
        function s(e) {
            function n() {
                if (!h) {
                    ...
                    if (c = function () {
                        ...
                        s.appendChild(o);
                        var a = c(o);
                        p = 200 === i(a.width), s.removeChild(o)
                    }
                }
            }
            ...
            function s(t) {
                if (n(), "string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                    ...
                    for (var r = s.isBorderBox = !(!u || !e[u] || "border-box" !== e[u]), h = 0, d = a.length; d > h; h++) {
                        var f = a[h],
                            m = e[f];
                        m = l(t, m);
                        var g = parseFloat(m);
            ...
            e(function () {
                for (var e = n.toDashed(o), r = document.querySelectorAll(".js-" + e), a = "data-" + e + "-options", l = 0, c = r.length; c > l; l++) {
                    ...
                    try {
                        ...
                        s && s.error("Error parsing " + a + " on " + p.nodeName.toLowerCase() + (p.id ? "#" + p.id : "") + ": " + t);
                        continue
                    }
                    var d = new i(p, u),
                        f = t.jQuery;
    ...
    function (t, e) {
        ...
        return n.prototype._resetLayout = function () {
            ...
            for (var s = this._getColGroup(o), r = Math.min.apply(Math, s), a = i.indexOf(s, r), l = {
                    ...
                    y: r
                }, c = r + t.size.outerHeight, u = this.cols + 1 - s.length, p = 0; u > p; p++) this.colYs[a + p] = c;
            return l
    ...
    function (t) {
        ...
        function n(i) {
            t.requestAnimationFrame(function () {
                "scroll" !== i.type && e();
                for (var t = 0, n = f.length; t < n; t++) "scroll" !== i.type && (f[t].coverImage(), f[t].clipContainer()), f[t].onScroll()
            })
        }
            ...
            m = function () {
                function t(t, i) {
                    ...
                    if (o.$item = t, o.defaults = {
                            ...
                            onDestroy: null,
                            onCoverImage: null
                        }, n = JSON.parse(o.$item.getAttribute("data-jarallax") || "{}"), o.options = o.extend({}, o.defaults, n, i), !(a && o.options.noAndroid || l && o.options.noIos)) {
                        o.options.speed = Math.min(2, Math.max(-1, parseFloat(o.options.speed)));
                        var s = o.options.elementInViewport;
                        s && "object" == typeof s && "undefined" != typeof s.length && (s = s[0]), !s instanceof Element && (s = null), o.options.elementInViewport = s, o.instanceID = e++, o.image = {
                            src: o.options.imgSrc || null,
                            $container: null,
                            $item: null,
                            width: o.options.imgWidth || null,
                            height: o.options.imgHeight || null,
                            useImgTag: l || a || c || p || h || u
                        }, o.initImg() && o.init()
                    }
                }
                var e = 0;
        ...
        m.prototype.css = function (e, i) {
            ...
            for (var o = e.$item; null !== o && o !== document && 0 === e.parentWithTransform;) {
                var s = e.css(o, "-webkit-transform") || e.css(o, "-moz-transform") || e.css(o, "transform");
                s && "none" !== s && (e.parentWithTransform = 1, e.css(e.image.$container, {
            ...
            for (var t = this, e = 0, i = f.length; e < i; e++)
            ...
            if (t.image.width && t.image.height) {
                var e = t.image.$container.getBoundingClientRect(),
                    ...
                    f = 0,
                    m = 0;
                u && (p = c * (n + s) / 2, (c < 0 || c > 1) && (p = c * Math.max(n, s) / 2), c < 0 || c > 1 ? d = Math.max(n, s) + 2 * Math.abs(p) : d += Math.abs(s - n) * (1 - c)), h = d * a / l, h < i && (h = i, d = h * l / a), t.bgPosVerticalCenter = 0, !(u && d < s) || r && t.options.enableTransform || (t.bgPosVerticalCenter = (s - d) / 2, d = s), u ? (f = o + (i - h) / 2, m = (s - d) / 2) : (f = (i - h) / 2, m = (n - d) / 2), r && t.options.enableTransform && t.parentWithTransform && (f -= o), t.parallaxScrollDistance = p, t.css(t.image.$item, {
                    width: h + "px",
                    height: d + "px",
                    marginLeft: f + "px",
                    marginTop: m + "px"
            ...
            if (e.image.width && e.image.height) {
                var i = e.$item.getBoundingClientRect(),
                    ...
                    c = i;
                if (e.options.elementInViewport && (c = e.options.elementInViewport.getBoundingClientRect()), e.isElementInViewport = c.bottom >= 0 && c.right >= 0 && c.top <= s && c.left <= o, t || e.isElementInViewport) {
                    var u = Math.max(0, n),
                        p = Math.max(0, a + n),
                        h = Math.max(0, -n),
                        f = Math.max(0, n + a - s),
                        ...
                        y = 1 - 2 * (s - n) / (s + a),
                        v = 1;
                    if (a < s ? v = 1 - (h || f) / a : p <= s ? v = p / s : m <= s && (v = m / s), "opacity" !== e.options.type && "scale-opacity" !== e.options.type && "scroll-opacity" !== e.options.type || (l.transform = "translate3d(0, 0, 0)", l.opacity = v), "scale" === e.options.type || "scale-opacity" === e.options.type) {
                        var w = 1;
                    ...
                    if ("scroll" === e.options.type || "scroll-opacity" === e.options.type) {
                        ...
                        r && e.options.enableTransform ? (e.parentWithTransform && (b -= n), l.transform = "translate3d(0, " + b + "px, 0)") : e.image.useImgTag ? l.top = b + "px" : (e.bgPosVerticalCenter && (b += e.bgPosVerticalCenter), l.backgroundPosition = "50% " + b + "px"), l.position = d ? "absolute" : "fixed"
                    }
    ...
    function (t) {
        ...
        o.prototype.parseURL = function (t) {
            ...
            function n(t) {
                for (var e = t.split(/,(?=mp4\:|webm\:|ogv\:|ogg\:)/), i = {}, n = 0, o = 0; o < e.length; o++) {
                    var s = e[o].match(/^(mp4|webm|ogv|ogg)\:(.*)/);
            ...
            var o = e(t),
                s = i(t),
                r = n(t);
            return o ? (this.type = "youtube", o) : s ? (this.type = "vimeo", s) : !!r && (this.type = "local", r)
        ...
        o.prototype.play = function (t) {
            var e = this;
            e.player && ("youtube" === e.type && e.player.playVideo && ("undefined" != typeof t && e.player.seekTo(t || 0), e.player.playVideo()), "vimeo" !== e.type || s || ("undefined" != typeof t ? (s = 1, e.player.setCurrentTime(t || 0).then(function () {
                e.player.play(), s = 0
            ...
            return i.$iframe ? void e(i.$iframe) : void i.onAPIready(function () {
                ...
                if ("local" === i.type) {
                    if (!i.$iframe) {
                        i.$iframe = document.createElement("video"), i.options.mute && i.$iframe.setAttribute("muted", "on"), i.options.loop && i.$iframe.setAttribute("loop", "on"), i.$iframe.setAttribute("id", i.playerID), s.appendChild(i.$iframe), document.body.appendChild(s);
                        for (var p in i.videoID) o(i.$iframe, i.videoID[p], "video/" + p)
                    }
                    i.player = i.player || i.$iframe;
                    var h;
                    n(i.player, "playing", function (t) {
                        h || i.fire("started", t), h = 1
        ...
        o.prototype.loadAPI = function () {
            ...
            if (!r || !a) {
                var i = "";
                if ("youtube" !== e.type || r || (r = 1, i = "//www.youtube.com/iframe_api"), "vimeo" !== e.type || a || (a = 1, i = "//player.vimeo.com/api/player.js"), i) {
        ...
        o.prototype.onAPIready = function (e) {
            ...
            if ("youtube" === i.type && ("undefined" != typeof YT && 0 !== YT.loaded || l ? "object" == typeof YT && 1 === YT.loaded ? e() : u.done(function () {
                ...
                if ("undefined" != typeof Vimeo || c) "undefined" != typeof Vimeo ? e() : p.done(function () {
                    e()
                });
                else {
                    c = 1;
                    var n = setInterval(function () {
                        "undefined" != typeof Vimeo && (clearInterval(n), p.resolve("done"), e())
                    }, 20)
                }
            "local" === i.type && e()
        }, t.VideoWorker = o
    ...
    function (t) {
        ...
        function a(n, o, a) {
            ...
            return l ? (o.shuffle && (n = s(n)), o.reverse && (n = n.toArray().reverse()), void t.each(n, function (n, s) {
                ...
                var u = t(s),
                    p = o.sync ? o.delay : o.delay * n * o.delayScale;
    ...
    function (t) {
        ...
        w.prototype = {
            ...
            open: function (i) {
                ...
                E("BeforeOpen"), e.st.showCloseBtn && (e.st.closeBtnInside ? (x(p, function (t, e, i, n) {
                ...
                }, 16), e.isOpen = !0, e.updateSize(u), E(h), i
            },
            close: function () {
            ...
            _parseMarkup: function (e, i, n) {
                var o;
                n.data && (i = t.extend(n.data, i)), E(p, [e, i, n]), t.each(i, function (i, n) {
        ...
        var k, z, $, L = "inline",
            O = function () {
                $ && (z.after($.addClass(k)).detach(), $ = null)
            };
                ...
                getInline: function (i, n) {
                    if (O(), i.src) {
                        ...
                        if (s.length) {
                            ...
                            r && r.tagName && (z || (k = o.hiddenClass, z = C(k), k = "mfp-" + k), $ = s.after(z).detach().removeClass(k)), e.updateStatus("ready")
        ...
        t.magnificPopup.registerModule(P, {
            ...
            proto: {
                initAjax: function () {
                    e.types.push(P), A = e.st.ajax.cursor, x(a + "." + P, M), x("BeforeChange." + P, M)
                },
                getAjax: function (i) {
                    ...
                    var n = t.extend({
                        ...
                        success: function (n, o, s) {
                            ...
                            E("ParseAjax", r), e.appendContent(t(r.data), P), i.finished = !0, D(), e._setFocus(), setTimeout(function () {
                                e.wrap.addClass(g)
        ...
        t.magnificPopup.registerModule("image", {
            ...
            proto: {
                initImage: function () {
                    var i = e.st.image,
                        n = ".image";
                    e.types.push("image"), x(h + n, function () {
        ...
        t.magnificPopup.registerModule("gallery", {
            ...
            proto: {
                initGallery: function () {
                    var i = e.st.gallery,
                        o = ".mfp-gallery";
                    return e.direction = !0, !(!i || !i.enabled) && (s += " mfp-gallery", x(h + o, function () {
            ...
            proto: {
                initRetina: function () {
                    if (window.devicePixelRatio > 1) {
                        var t = e.st.retina,
                            i = t.ratio;
                        i = isNaN(i) ? i() : i, i > 1 && (x("ImageHasSize." + Y, function (t, e) {
                            e.img.css({
        ...
        function o(e, i) {
            this.settings = null, this.options = t.extend({}, o.Defaults, i), this.$element = t(e), this.drag = t.extend({}, h), this.state = t.extend({}, d), this.e = t.extend({}, f), this._plugins = {}, this._supress = {}, this._current = null, this._speed = null, this._coordinates = [], this._breakpoint = null, this._width = null, this._items = [], this._clones = [], this._mergers = [], this._invalidated = {}, this._pipe = [], t.each(o.Plugins, t.proxy(function (t, e) {
    ...
    function (t, e, i) {
        ...
        n.Defaults = {
            ...
            return e.wrap('<div class="owl-video-wrapper"' + r + "></div>"), this._core.settings.lazyLoad && (l = "data-src", c = "owl-lazy"), a.length ? (p(a.attr(l)), a.remove(), !1) : void("youtube" === i.type ? (s = "http://img.youtube.com/vi/" + i.id + "/hqdefault.jpg", p(s)) : "vimeo" === i.type && t.ajax({
                type: "GET",
    ...
    function (t, e) {
        ...
        function c(t) {
            var e, i, n, o, s = {};
            for (t = t.replace(/\s*:\s*/g, ":").replace(/\s*,\s*/g, ","), e = t.split(","), o = 0, i = e.length; i > o; o++) e[o] = e[o].split(":"), n = e[o][1], ("string" == typeof n || n instanceof String) && (n = "true" === n || "false" !== n && n), ("string" == typeof n || n instanceof String) && (n = isNaN(n) ? n : +n), s[e[o][0]] = n;
            return s
        }
        ...
        h.prototype.open = function () {
            ...
            return this.each(function (o, s) {
                n = e(s), null == n.data(m) ? (i = new h(n, t), n.data(m, i.index), i.settings.hashTracking && n.attr("data-" + m + "-id") === location.hash.substr(1) && i.open()) : i = e[m].lookup[n.data(m)]
            }), i
        ...
        return e.prototype = {
            ...
            getViewportH: function () {
                var e = s.config.viewport.clientHeight,
                    i = t.innerHeight;
                return s.config.viewport === t.document.documentElement && e < i ? i : e
            },
            scrollY: function () {
    ...
    function (t) {
        ...
        function e() {
            function e() {
                t(".load-more-btn").addClass("disable").find("span").text("All items loaded")
            }
            var i = 0,
                n = parseInt(t(".load-more-btn").attr("data-load"), 10);
            t(".load-more-btn").on("click", function (o) {
                o.preventDefault(), t.ajax({
                    cache: !1,
                    dataType: "html",
                    msg: "",
                    success: function (o) {
                        var s = t(o).filter(".crazy-portfolio-item"),
                            r = s.length,
                            a = "";
                        if (r > 0)
                            if (i !== r) {
                                for (var l = 0; i < r && l < n; i++, l++) a += s.eq(i).prop("outerHTML");
                                t(".crazy-portfolio-list").append(a), t(".crazy-portfolio-list").imagesLoaded(function () {
                                    t(window).trigger("resize"), t(".crazy-portfolio-list").isotope("reloadItems").isotope(), setBg(), hoverlightbox()
                                }), (r <= n || i == r) && e()
                            } else e();
                        else e()
                    },
                    type: "POST",
                    url: t(".load-more-btn").attr("href")
                })
            })
        }
        t(document).ready(function () {
            "undefined" != typeof t.fn.imagesLoaded && "undefined" != typeof t.fn.isotope && t(".crazy-portfolio-list").imagesLoaded(function () {
                var e = t(".crazy-portfolio-list");
                e.isotope({
                    itemSelector: ".crazy-portfolio-item",
                    layoutMode: "masonry",
                    transitionDuration: "0.8s"
                }), t(".filters li").on("click", function () {
                    t(this);
                    t(".filters").find("li").removeClass("active-filter"), t(this).addClass("active-filter");
